...
import { coinAPI, portfolioAPI, Portfolio } from '@/lib/api'
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function ImportCoinsSettings() {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-slate-50 rounded-lg">
            <Label className="mb-2 block">Select Portfolio</Label>
            {loadingPortfolios ? (
          ...
          {result && (
            <div className="space-y-3">
              ...
              <Button
                onClick={() => {
                  setOpen(false)
                  // Reload page to show imported coins
